...
link_dotfiles() {
    ...
    # .zshenv runs for every zsh invocation (incl. non-interactive), unlike
    # .zshrc — needed so dotfiles-shipped scripts (zsh/bin/) resolve in
    # hooks/subagents/tool-invoked shells that never source .zshrc.
